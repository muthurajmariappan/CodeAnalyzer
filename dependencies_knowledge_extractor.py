...
"""
    ...
    def execute_prompt(self, prompt: str, max_tokens: int):
        try:
            ...
            with open("D:\\self\\CodeAnalyzer\\out\\" + "d-prompt.txt", "w", encoding='utf-8') as file:
                file.write(prompt)

            with open("D:\\self\\CodeAnalyzer\\out\\" + "d-messages.txt", "w", encoding='utf-8') as file:
            ...
            with open("D:\\self\\CodeAnalyzer\\out\\" + "d-llm-response.txt", "w", encoding='utf-8') as file:
